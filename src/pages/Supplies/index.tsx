...
import { formatDate, daysUntilExpire } from '../../utils';
import { PieChart, Pie, Cell, ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Tooltip, CartesianGrid } from 'recharts';

export default function Supplies() {
  const { supplies, places } = useAppStore();
                  ...
                  <tr key={supply.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        ...
                        <button className="px-3 py-1.5 text-sm text-green-600 hover:bg-green-50 rounded transition-colors">
                          出入库
                        </button>
                      </div>
                    </td>
